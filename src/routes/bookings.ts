...
router.patch(
  ...
  async (req: AuthRequest, res: Response) => {
    ...
    const booking = await pool.query(
      'SELECT b.id, b.worker_id, b.user_id, b.status, b.price, b.commission FROM bookings b JOIN workers w ON w.id = b.worker_id WHERE b.id = $1 AND (b.user_id = $2 OR w.user_id = $2)',
      [id, req.user!.id]
    );
